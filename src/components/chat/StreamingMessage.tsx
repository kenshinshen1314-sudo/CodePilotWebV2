                    ...
                    <div key={qIdx} className="space-y-2">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {q.options.map((opt) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`rounded-lg border h-8 px-3 text-sm font-medium transition-colors ${isSelected
                            ...
                            <button
                                ...
                                className={`rounded-lg border h-8 px-3 text-sm font-medium transition-colors ${useOther[qIdx]
                                    ? 'border-primary bg-primary/10 text-primary'
                                    : 'border-border bg-background text-foreground hover:bg-muted'
                                    }`}
                            >
