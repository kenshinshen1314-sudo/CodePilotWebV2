...
export const MessageItem = memo(function MessageItem({ message }: MessageItemProps) {
    ...
    // Hide image-gen system notices early — they exist in DB for Claude's context but shouldn't render
    // This must be checked AFTER the isUser check but BEFORE any hooks that depend on content
    const isHiddenNotice = isUser && message.content.startsWith('[__IMAGE_GEN_NOTICE__');
