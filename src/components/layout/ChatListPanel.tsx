        ...
        >
            ...
            <div className="flex items-center gap-2 px-3 pb-3">
                <Button
                    variant="default"
                    size="sm"
                    className="flex-1 justify-center gap-1.5 h-9 text-xs font-medium"
            ...
            <div className="px-3 pb-2">
                <Button
                    variant="ghost"
                    size="sm"
                    className="w-full justify-start gap-2 h-8 text-sm text-muted-foreground hover:text-foreground hover:bg-accent"
                    onClick={() => setImportDialogOpen(true)}
                >
                    <HugeiconsIcon icon={FileImportIcon} className="h-4 w-4" />
                ...
                <div className="flex flex-col pb-3">
                    ...
                    {isSplitActive && (
                        <div className="mb-3 rounded-xl border border-border/50 bg-muted/40 p-2">
                            <div className="flex items-center gap-2 px-2 py-1.5">
                                ...
                                <span className="text-xs font-semibold text-muted-foreground">{t('split.splitGroup')}</span>
                            </div>
                                ...
                                {splitSessions.map((session) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={cn(
                                                "group relative flex items-center gap-2 rounded-lg pl-7 pr-8 py-2 transition-all duration-200 min-w-0 cursor-pointer",
                                                "hover:bg-accent/50",
                                                isActiveInSplit
                                        ...
                                        >
                                            {isSessionStreaming && (
                                                <span className="absolute left-2 top-1/2 -translate-y-1/2 flex h-2 w-2 shrink-0">
                                                    <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-green-400 opacity-75" />
                                                    <span className="relative inline-flex h-2 w-2 rounded-full bg-green-500" />
                                                </span>
                                            )}
                                            {needsApproval && (
                                                <span className="absolute left-2 top-1/2 -translate-y-1/2 flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-amber-500/10">
                                            ...
                                            <Button
                                                variant="ghost"
                                                size="icon"
                                                className="absolute right-1 top-1/2 -translate-y-1/2 h-6 w-6 shrink-0 text-muted-foreground/60 hover:text-foreground hover:bg-accent opacity-0 group-hover:opacity-100 transition-all"
                                                onClick={(e) => {
                                                    e.stopPropagation();
                    ...
                    {filteredSessions.length === 0 && (!isSplitActive || splitSessions.length === 0) ? (
                        ...
                        projectGroups.map((group) => {
                            ...
                            return (
                                <div key={group.workingDirectory || "__no_project"} className="mt-2 first:mt-0">
                                    {/* Folder header */}
                                    <Tooltip>
                                        <TooltipTrigger asChild>
                                            <div
                                                className={cn(
                                                    "flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 cursor-pointer select-none transition-all duration-200",
                                                    "hover:bg-accent/50"
                                                )}
                                                    ...
                                                    <Tooltip>
                                                        <TooltipTrigger asChild>
                                                            <Button
                                                                ...
                                                                size="icon"
                                                                className={cn(
                                                                    "h-6 w-6 shrink-0 text-muted-foreground hover:text-foreground transition-all",
                                                                    isFolderHovered ? "opacity-100 scale-100" : "opacity-0 scale-75"
                                                                )}
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <Link
                                                            ...
                                                            className={cn(
                                                                "flex items-center gap-2 rounded-lg pl-2.5 pr-7 py-2 transition-all duration-200 min-w-0",
                                                                "hover:bg-accent/50",
                                                                isActive
                                                                    ? "bg-sidebar-accent text-sidebar-accent-foreground shadow-sm"
                                                                    : "text-sidebar-foreground"
                                                        ...
                                                        >
                                                            ...
                                                            <span className="relative flex h-4 w-4 shrink-0 items-center justify-center">
                                                                ...
                                                                {canSplit && (
                                                                    <button
                                                                        className={cn(
                                                                            "absolute inset-0 flex items-center justify-center text-muted-foreground hover:text-foreground transition-all",
                                                                ...
                                                                {needsApproval && !isSessionStreaming && (
                                                                    <span className={cn(
                                                                        "flex h-4 w-4 items-center justify-center rounded-full bg-amber-500/10 transition-opacity",
                                                                        isHovered && canSplit ? "opacity-0" : "opacity-100"
                                                                    )}>
                                                                        <HugeiconsIcon icon={Notification02Icon} className="h-2.5 w-2.5 text-amber-500" />
                                                                    </span>
            ...
            {/* Version */}
            <div className="shrink-0 px-3 py-3 text-center border-t border-border/40">
