        ...
        <div className="rounded-lg bg-muted/30 p-4 space-y-2">
          ...
          {sorted.length > 0 ? (
            sorted.map((provider) => (
              <div
                key={provider.id}
                className="py-2.5 px-1 border-b border-border/10 last:border-b-0"
              >
        ...
        <div className="rounded-lg bg-muted/30 p-4">
          ...
          <div className="mb-1">
            ...
            {QUICK_PRESETS.filter((p) => p.category !== "media").map((preset) => (
              <div
                key={preset.key}
                className="flex items-center gap-3 py-2.5 px-1 border-b border-border/10 last:border-b-0"
              >
